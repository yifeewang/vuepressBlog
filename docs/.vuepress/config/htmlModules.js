...
module.exports = {
    ...
    <p style="
      ...
      margin: 0 0 8px 0;
    ">微信</p>
    <img src="https://20220502-1309090431.cos.ap-shanghai.myqcloud.com/myBlog/yifee_v.jpg"  style="width:100%;" />
    <p style="
      color: var(--textColor);
      opacity: 0.9;
      font-size: 20px;
      ...
      margin: 0 0 8px 0;
    ">围脖</p>
    <a href="https://weibo.com/u/3178634520">欢迎进入我的围脖emmmm</a>
    <p>
    添加微信，回复[<b>前端资源</b>]，可获取 <a href="https://github.com/yifeewang" arget="_blank" >前端学习资源<span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a>
    </p>
    </div>`,
    // `<!-- 纵向自适应 -->
